      ...
      <div class="modal-content">
        <div v-if="Object.keys(currentSettings).length > 0" class="modal-body">
          ...
          <table class="table table-hover table-bordered">
            ...
            <tbody>
              <tr v-for="(rel, key, index) in currentSettings.graphViz.rels" :key="index">
                ...
                <td>
                  <input v-model="rel.g6Settings.style.stroke" @change="syncRelFill(rel)" type="color"
                    class="form-control form-control-color" title="Choose color for rel">
                </td>
                <td>
          ...
          <div class="input-group flex-nowrap">
            ...
            <input v-model="currentSettings.gpt.apiToken" type="text" class="form-control"
