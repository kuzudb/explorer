  ...
  <div ref="wrapper" class="schema-view__wrapper">
    ...
    <div ref="sidePanel" class="schema_side-panel__wrapper">
      ...
      <SchemaSidebarOverview v-if="schema" v-show="!hoveredLabel && clickedLabel === null" ref="overview"
        :schema="schema" @drop-table="dropTable" @drop-rdf="dropRdf" @edit-table="enterEditTableMode"
        @add-node-table="enterAddNodeTableMode" @add-rel-table="enterAddRelTableMode"
        @add-rel-group="enterAddRelGroupMode" @add-rdf="addRdf" />
      ...
      <SchemaSidebarEditView v-if="clickedLabel !== null && !clickedIsNewTable && !isClickedReadOnly()" ref="editView"
        :schema="schema" :label="clickedLabel" :is-node="clickedIsNode" @drop-property="dropProperty" @back="resetClick"
        @drop-table="dropTable" @rename-property="renameProperty" @rename-table="renameTable"
      ...
      <SchemaSidebarAddView v-if="clickedLabel !== null && clickedIsNewTable" ref="addView" :schema="schema"
        :label="clickedLabel" :is-node="clickedIsNode" :is-rel-group="clickedIsRelGroup" @discard="cancelAdd"
        @save="addNewTable" @update-node-table-label="updatePlaceholderNodeTableLabel"
